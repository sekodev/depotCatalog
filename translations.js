...
window.DEPOT_LANGUAGES = [
  ...
  /* ------------------ ENGLISH ------------------ */
  {
    ...
    strings: {
      ...
      hintInlineEdit: "Enter to save · Esc to cancel",
      hintAddJump: "Tip: Press Enter in Product Name to jump to Location.",
  ...
  /* ------------------ TÜRKÇE ------------------ */
  {
    ...
    strings: {
      ...
      hintInlineEdit: "Kaydetmek için Enter · İptal için Esc.",
      hintAddJump: "İpucu: Ürün Adı'nda Enter'a basarak Konum alanına geçin.",
      keyTabShift: "Tab / Shift+Tab",
