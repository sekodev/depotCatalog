...
window.DEPOT_LANGUAGES = [
  ...
  /* ------------------ ENGLISH ------------------ */
  {
    ...
    strings: {
      ...
      delSelectedCount: "Delete selected ({n})",
      delSelectedTitle: "🗑️ Delete selected",
      delSelectedMsg: "Delete {n} selected items? This cannot be undone.",
      nSelected: "{n} items selected.",
      nDeleted: "{n} items deleted.",
  ...
  /* ------------------ TÜRKÇE ------------------ */
  {
    ...
    strings: {
      ...
      delSelectedCount: "Seçilenleri sil ({n})",
      delSelectedTitle: "🗑️ Seçilenleri sil",
      delSelectedMsg: "Seçilen {n} kaydı silmek istiyor musunuz? Bu işlem geri alınamaz.",
      nSelected: "{n} kayıt seçildi.",
      nDeleted: "{n} kayıt silindi.",
      ...
      bulkEditCount: "Seçilenleri düzenle ({n})",
