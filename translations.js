...
window.DEPOT_LANGUAGES = [
  ...
  /* ------------------ ENGLISH ------------------ */
  {
    ...
    strings: {
      ...
      delTitle: "🗑️ Remove Product",
      delConfirm: "Remove “{name}”? This cannot be undone.",
      del: "Remove",
      ...
      sortAriaUnsorted: "Sort by {col}, currently unsorted. Click to sort ascending.",
      sortAriaAsc: "Sort by {col}, currently ascending. Click to sort descending.",
      sortAriaDesc: "Sort by {col}, currently descending. Click to clear sorting.",
      sortAnnAsc: "Sorted by {col}, ascending.",
      sortAnnDesc: "Sorted by {col}, descending.",
      sortAnnCleared: "Sort cleared.",
      /* Fix (bulk icons): icon buttons carry icon + count only; the accessible
         name is this descriptive label (also the hover tooltip title) */
      bulkDeleteSelected: "Remove selected items ({count})",
      delSelectedTitle: "🗑️ Remove selected",
      delSelectedMsg: "Remove {n} selected items? This cannot be undone.",
      nSelected: "{n} items selected.",
      nDeleted: "{n} items removed.",
      selectionCleared: "Selection cleared.",
      selectItemAria: "Select {name} at {location}",
      selectAllAria: "Select all items on this page",
      ...
      deleteDepotTitle: "🗑️ Remove Depot",
      editDepotAria: "Edit depot: {name}",
      deleteDepotAria: "Remove depot: {name}",
      deleteDepotConfirm: "“{name}” and all its items will be permanently removed. Continue?",
      depotNameLbl: "Depot name",
      depotNameReq: "❌ Depot name is required.",
      depotAdded: "✅ Depot added.",
      depotRenamed: "✅ Depot renamed.",
      depotDeleted: "✅ Depot removed.",
      noDepotMsg: "No depot. Add a depot to start organizing your items.",
      /* Fix (bulk edit): three-step bulk edit (choose fields → preview → report) */
      /* Fix (bulk icons): icon buttons carry icon + count only; the accessible
         name is this descriptive label (also the hover tooltip title) */
      bulkEditSelected: "Edit selected items ({count})",
      bulkScope: "{n} items will be changed.",
      bulkEditTitle: "✏️ Edit selected",
      bulkFieldName: "Name",
      bulkConfirmTitle: "⚠️ Confirm bulk edit",
      bulkContinue: "Continue",
      bulkApplyBtn: "Apply changes",
      ...
      bulkResultTitle: "✅ Bulk edit complete",
  ...
  /* ------------------ TÜRKÇE ------------------ */
  {
    ...
    strings: {
      ...
      delTitle: "🗑️ Ürünü Kaldır",
      delConfirm: "“{name}” kaldırılsın mı? Bu işlem geri alınamaz.",
      del: "Kaldır",
      ...
      sortAriaUnsorted: "{col} alanına göre sıralama yok. Artan sıralamak için tıklayın.",
      sortAriaAsc: "{col} alanı artan sıralı. Azalan sıralamak için tıklayın.",
      sortAriaDesc: "{col} alanı azalan sıralı. Sıralamayı kaldırmak için tıklayın.",
      sortAnnAsc: "{col} alanına göre artan sıralandı.",
      sortAnnDesc: "{col} alanına göre azalan sıralandı.",
      sortAnnCleared: "Sıralama temizlendi.",
      /* Fix (bulk icons): icon buttons carry icon + count only; the accessible
         name is this descriptive label (also the hover tooltip title) */
      bulkDeleteSelected: "Seçilen kayıtları kaldır ({count})",
      delSelectedTitle: "🗑️ Seçilenleri kaldır",
      delSelectedMsg: "Seçilen {n} kaydı kaldırmak istiyor musunuz? Bu işlem geri alınamaz.",
      nSelected: "{n} kayıt seçildi.",
      nDeleted: "{n} kayıt kaldırıldı.",
      selectionCleared: "Seçim temizlendi.",
      selectItemAria: "{name} — {location} seç",
      selectAllAria: "Bu sayfadaki tüm kayıtları seç",
      ...
      deleteDepotTitle: "🗑️ Depoyu Kaldır",
      editDepotAria: "Depoyu düzenle: {name}",
      deleteDepotAria: "Depoyu kaldır: {name}",
      deleteDepotConfirm: "“{name}” ve içindeki tüm kayıtlar kalıcı olarak kaldırılacak. Devam edilsin mi?",
      depotNameLbl: "Depo adı",
      depotNameReq: "❌ Depo adı gereklidir.",
      depotAdded: "✅ Depo eklendi.",
      depotRenamed: "✅ Depo adı değiştirildi.",
      depotDeleted: "✅ Depo kaldırıldı.",
      noDepotMsg: "Depo yok. Kayıtlarınızı düzenlemek için bir depo ekleyin.",
      /* Fix (bulk edit): üç adımlı toplu düzenleme (alan seç → önizleme → rapor) */
      /* Fix (bulk icons): icon buttons carry icon + count only; the accessible
         name is this descriptive label (also the hover tooltip title) */
      bulkEditSelected: "Seçilen kayıtları düzenle ({count})",
      bulkScope: "{n} öğe değiştirilecek.",
      bulkEditTitle: "✏️ Seçilenleri düzenle",
      bulkFieldName: "Ürün Adı",
      bulkConfirmTitle: "⚠️ Toplu düzenlemeyi onayla",
      bulkContinue: "Devam",
      bulkApplyBtn: "Değişiklikleri uygula",
      ...
      bulkResultTitle: "✅ Toplu düzenleme tamamlandı",
