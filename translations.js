...
window.DEPOT_LANGUAGES = [
  ...
  /* ------------------ ENGLISH ------------------ */
  {
    ...
    strings: {
      ...
      dupWarnMsgEdit: "⚠️ A product with this name already exists at another location. Save anyway?",
  ...
  /* ------------------ TÜRKÇE ------------------ */
  {
    ...
    strings: {
      ...
      dupWarnMsgEdit: "⚠️ Aynı adda ürün başka bir konumda zaten var. Yine de kaydedilsin mi?",
